        ...
        >
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-slate-500 max-w-xl text-lg font-medium leading-relaxed">
              El sistema <span className="text-blue-600 font-bold">Machi´s Shop</span> integra inventario y ventas en una solución unificada. Mejora tu flujo de trabajo hoy.
            </p>
